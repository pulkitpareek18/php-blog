        ...
        $sql_search = "select * from `search`";
            ...
            $max_post = $row_search['max_post'];  
                ...
                if(isset($_GET['number'])){
                    ...
                    $sql_num = "SELECT * from `blogpost` where content like '%$search_query%' or title like '%$search_query%'";
                    ...
                    $num_total_matched_posts = mysqli_num_rows($result_num);
                            ...
                            $sql = "SELECT * from `blogpost` where content like '%$search_query%' or title like '%$search_query%' limit $multiply , $max_post ";
                            ...
                            if ($num > 0) {
                                ...
                                "  class="   alert alert-success m-3 " role="alert"  >
                                    ...
                                    <a class="btn btn-outline-danger" style="text-decoration: none" href="/blog/blogpost.php?slug='.$slug.'">Read More</a>
                                    </div></section>';
                                ...
                                if($num_total_matched_posts>$multiply){
                                  ...
                                  echo '<div style="text-align: left;"><a class="btn btn-danger "  id="previous" href="/blog/bsearch.php?search_query='.$search.'&number='.$multiply_by_prev.'"><- Previous</a></div>';
                                    ...
                                    echo '<div style="text-align: right;"><a class="btn btn-danger mt-0 "  id="next" href="/blog/bsearch.php?search_query='.$search.'&number='.$multiply_by_next.'">Next -></a></div>';
