...
<div class="allData  d-flex flex-column justify-content-center align-items-center">
  ...
  <div class='d-flex flex-align-center justify-content-start'>
    <h1>All Playlists</h1>
    <div class='d-flex flex-align-center justify-content-start'>
      <button onClick='selectAll(this)' class='delete ml-2 btn btn-sm btn-primary'>
        <div class='d-flex align-items-center flex-center text-center justify-content-start'><img src="../img/checkmark.svg" alt=""><em id="selectText">Select All</em></div>
      </button>
    ...
    <tbody>
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<tr>
                ...
                <td>
                  <div class='d-flex flex-align-center justify-content-start'>
                    <a class='edit btn btn-sm btn-primary' href='" . $home_url . "admin/playlistedit.php?id=" . $row['category_id'] . "'>Edit</a>
                    <button onClick='" . $function . "'class='delete ml-2 btn btn-sm btn-secondary'>" . $text . "</button>
                    <button onClick='".$delete_function."'class='delete ml-2 btn btn-sm btn-danger'>Delete</button>
                  </div>
                </td>
              </tr>";
      }
